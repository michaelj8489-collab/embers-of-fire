  ...
  useEffect(() => {
    ...
    const checkRecoverySession = async () => {
      ...
      if (sessionError || !data.session) {
        ...
        setError('This recovery link is invalid or expired. Please request a new one.');
      } else {
        setHasRecoverySession(true);
        setError(null);
      }
  ...
  return (
    <main className="relative min-h-screen w-full flex flex-col items-center justify-center py-24 px-4 font-cormorant text-gray-200">
      ...
      <div className="relative z-20 flex flex-col items-center bg-black/60 p-8 rounded-xl border border-orange-900/50 shadow-[0_0_30px_rgba(0,0,0,0.8)] w-full max-w-md">
        ...
        {checkingSession && <p className="text-orange-400 mb-4 font-cinzel text-sm text-center uppercase">Checking recovery link...</p>}
        ...
        {!checkingSession && !hasRecoverySession ? (
          <Link
            ...
            className="bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-500 hover:to-red-500 text-white font-bold py-3 px-6 rounded transition-all font-cinzel tracking-widest uppercase text-center"
          >
