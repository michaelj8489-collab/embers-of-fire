        ...
        <main className="flex-grow flex flex-col items-center pt-24 pb-12 px-4 w-full">
          <div className="w-full max-w-4xl">
            ...
            <div className="text-center mb-16">
              <h1 className="font-cinzel-decorative font-bold text-5xl md:text-7xl mb-6 uppercase tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-[#FF4500] via-[#FFD700] to-[#FF4500]">Voices On The Rise</h1>
              <p className="font-cinzel text-2xl text-[#FFF8DC]/90 italic tracking-wide">"Celebrating the emerging voices of our community."</p>
            </div>
            ...
            <div className="bg-[#4B0082]/10 border-l-4 border-[#FF4500] p-8 rounded-r-xl">
               <h4 className="font-cinzel text-[#FF8C00] mb-4 uppercase tracking-widest">About Voices On The Rise</h4>
               <p className="font-cormorant text-xl text-[#FFF8DC]/80 leading-relaxed italic">Welcome to Voices On The Rise. This dedicated space is designed to showcase the unique energy and vocal expression that defines the RISE community. Join us as we tune into the frequencies that inspire connection, creativity, and the power of independent music.</p>
            </div>
          </div>
        </main>
        <Footer />
