...
export default function RockRewindPage() {
  return (
    <div className="relative min-h-screen w-full flex flex-col overflow-hidden font-cormorant text-gray-200">
      <div className="absolute inset-0 z-0">
        <img src="/images/media-4/rock-rewind.png" alt="Rock Rewind Background" className="w-full h-full object-cover fixed opacity-40" />
        ...
        <main className="flex-grow flex flex-col items-center pt-24 pb-12 px-4 w-full">
          <div className="w-full max-w-4xl">
            ...
            <div className="text-center mb-16">
              <h1 className="font-cinzel-decorative font-bold text-5xl md:text-7xl mb-6 uppercase tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-[#FF4500] via-[#FFD700] to-[#FF4500]">The Rock Rewind</h1>
              <p className="font-cinzel text-2xl text-[#FFF8DC]/90 italic tracking-wide">"Revisiting the anthems that defined a generation."</p>
            </div>
            <div className="w-full bg-black/60 backdrop-blur-md p-8 rounded-2xl border border-[#4B0082]/50 shadow-[0_0_50px_rgba(75,0,130,0.3)] mb-12">
               <h3 className="font-cinzel text-[#FFD700] text-center mb-8 tracking-[0.2em] uppercase">The Rock Rewind: Live Broadcast</h3>
            ...
            <div className="bg-[#4B0082]/10 border-l-4 border-[#FF4500] p-8 rounded-r-xl">
               <h4 className="font-cinzel text-[#FF8C00] mb-4 uppercase tracking-widest">About The Rock Rewind</h4>
               <p className="font-cormorant text-xl text-[#FFF8DC]/80 leading-relaxed italic">Welcome to The Rock Rewind. This dedicated space is designed to showcase the unique energy and powerful expression that defines the RISE community. Join us as we tune into the frequencies that inspire connection, creativity, and the power of independent music.</p>
            </div>
          </div>
        </main>
        <Footer />
