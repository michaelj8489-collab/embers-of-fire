        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <a
              ...
              className="p-5 bg-zinc-900/50 border border-orange-500/30 rounded-xl hover:border-orange-500 hover:bg-orange-600/10 transition-all text-center text-orange-300 uppercase tracking-widest font-bold"
            >
              Site Analytics
            </a>
          </div>
