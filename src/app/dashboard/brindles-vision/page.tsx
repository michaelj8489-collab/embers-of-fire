        ...
        <main className="flex-grow flex flex-col items-center pt-24 pb-12 px-4 w-full">
          <div className="w-full max-w-5xl">
            ...
            <div className="mb-16 relative">
              ...
              <div className="w-full aspect-video bg-black border border-orange-900/50 rounded-xl overflow-hidden shadow-[0_0_30px_rgba(234,88,12,0.15)] bg-cover bg-center flex items-center justify-center relative z-20"
                   style={{ backgroundImage: "url('/images/jmc-edits-palettes/show-offline-placeholder.png')" }}>
                
                <iframe
                  src="https://player.twitch.tv/?channel=riseradionetwork&parent=embers-of-fire-4lgo.vercel.app&muted=true&autoplay=false"                  className="absolute top-0 left-0 w-full h-full z-30"
                  frameBorder="0"
