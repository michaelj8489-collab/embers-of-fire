                ...
                {activeView === 'live' ? (
                  <div className="flex flex-col md:flex-row w-full aspect-video md:aspect-auto md:h-[600px]">
                    <div className="flex-grow h-full bg-black">
                      <iframe
                        src={`https://player.twitch.tv/?channel=riseradionetworks&parent=${process.env.NEXT_PUBLIC_TWITCH_PARENT}&muted=true&autoplay=false`}  className="w-full h-full" frameBorder="0" allowFullScreen={true}
                        />
                    </div>
