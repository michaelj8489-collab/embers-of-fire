              ...
              <div className="flex flex-col md:flex-row items-center gap-12 mb-20">
                ...
                <div className="w-full md:w-1/2 flex flex-col justify-center">
                  ...
                  <div className="font-cormorant text-xl text-gray-300 space-y-5 leading-relaxed">
                    ...
                    <p>
                      Each week, to kick off the show, this dynamic trio performs a vital ritual: sitting in entirely different states, within the sanctity of their own spaces, they each pull a single card from their individual tarot decks. The crucial factor that makes this guidance unique is that none of them have any clue what the others have pulled until the show actually starts. This total blind reveal ensures that the messages are completely organic, born from the purity of their own individual connections to the universe around us all.
                    </p>
                    <p>
                      As they reveal their cards live on air, something truly magical often happens—the cards align so perfectly that they seem planned, as if one person's card finishes the story told by the previous one, effortlessly coming together into one cohesive message. That undeniable synchronicity is where their iconic catchphrase was born: <strong className="text-orange-500 font-bold">"We can't make this sh*t up!"</strong>
                    </p>
                    <p>
                      Fusing their distinct perspectives, and pulling additional cards as the episode unfolds for even further enlightenment, they blend deep wisdom, intuition, spiritual insight, real-world coaching, and, of course, humor, to show you exactly how to practically apply these cosmic messages to your everyday life.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="w-full md:w-1/2 flex flex-col justify-center">
                  ...
                  <div className="font-cormorant text-xl text-gray-300 space-y-5 leading-relaxed">
                    ...
                    <blockquote className="border-l-4 border-orange-500/50 pl-5 py-3 my-4 italic text-orange-200/90 bg-orange-950/20 rounded-r-lg">
                      "You know, the three of you would do really well together doing a podcast. Why don't you guys think about starting a podcast where it's all three of you?"
                    </blockquote>
                    <p>
                      When Michka brought his mother's brilliant observation to Karrie and Rev. D, Karrie immediately recognized the potential, replying, <span className="italic text-orange-300">"Hey, you know what would be a good idea?"</span>
                    </p>
                    <p>
                      In a world of billions of people where starting a podcast is easier than ever, the trio set out with a specific mission: to create something truly unique that nobody else was doing. By combining their individual spiritual gifts, geographical distance, and coaching styles into one unified voice, they brought that vision to life—and <em className="text-orange-400 font-semibold">The CORE</em> was born.
                    </p>
                  </div>
                </div>
              </div>
...
            <section className="w-full mt-12 mb-24 text-center border-t border-orange-900/20 pt-20">
